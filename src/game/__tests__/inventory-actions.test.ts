...
describe('capacity display helpers (Phase 11.2)', () => {
  ...
  it('an intermediate value sums across item ids', () => {
    const state = freshState({
      inventory: { apple: 3, sword: 1, armor: 0, spear: 0, hammer: 0, sun_fruit: 2, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
    });
...
describe('place_item success (Phase 11.2)', () => {
  it('decreases inventory by exactly 1 from 2+', () => {
    const state = freshState({
      inventory: { apple: 3, sword: 0, armor: 0, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
    });
    processTurn(state, { type: 'place_item', itemId: 'apple' });
  ...
  it('decreases inventory to 0 when placing the last copy', () => {
    const state = freshState({
      inventory: { apple: 1, sword: 0, armor: 0, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
    });
    processTurn(state, { type: 'place_item', itemId: 'apple' });
  ...
  it('placing a weapon still owned 2+ times leaves 1 remaining and equipped', () => {
    const state = freshState({
      inventory: { apple: 0, sword: 2, armor: 0, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
...
describe('place_item failure (Phase 11.2)', () => {
  ...
  it('cannot place the last copy of a currently-equipped weapon', () => {
    const state = freshState({
      inventory: { apple: 0, sword: 1, armor: 0, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
      equippedWeaponId: 'sword',
    });
    const result = processTurn(state, { type: 'place_item', itemId: 'sword' });
    expect(result.consumed).toBe(false);
  ...
  it('cannot place the last copy of currently-equipped armor', () => {
    const state = freshState({
      inventory: { apple: 0, sword: 0, armor: 1, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
...
describe('selection correction after place/discard (Phase 11.2)', () => {
  ...
  it('selectedItemId returns the entry at the current index', () => {
    const state = freshState({
      inventory: { apple: 1, sword: 1, armor: 0, spear: 0, hammer: 0, sun_fruit: 0, solar_gun: 0, sol_enchantment: 0, chocolate: 0, banana: 0 },
      selectedItemIndex: 1,
    });
