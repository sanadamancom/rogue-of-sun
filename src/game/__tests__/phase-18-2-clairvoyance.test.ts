...
describe('clairvoyance fruit (Phase 18.2)', () => {
  it('is available in the floor 1 ground item pool', () => {
    expect(getGroundItemPoolForFloor(1, 'descent')).toContain('clairvoyance_fruit');
    expect(getGroundItemPoolForFloor(2, 'descent')).toContain('clairvoyance_fruit');
    expect(getGroundItemPoolForFloor(3, 'descent')).toContain('clairvoyance_fruit');
  });
