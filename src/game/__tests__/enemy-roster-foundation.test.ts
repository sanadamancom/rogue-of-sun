...
describe('enemy roster foundation (Phase 06 + density correction)', () => {
  it('registers all 12 species with a unique id matching its record key', () => {
    // Phase 23.1 appended 'skeleton' (9->10); Phase 23.3 appended 'ghost' (10->11); Phase 23.4 appended 'steps' (11->12).
  ...
  describe('roster preview (test/dev-only: all 12 species at once)', () => {
